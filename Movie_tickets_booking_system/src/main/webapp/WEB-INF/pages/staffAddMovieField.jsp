...
<body>
	...
	<form action="<%=request.getContextPath().toString()%>/submitFieldMessage" method="post">
		<table>
			...
			<tr>
				<td>开始时间</td><td><input type="text" name="startTime"></td><td><p style="color:#C0C0C0">格式为:hh:mm:ss</p></td>
			</tr>
			<tr>
				<td>结束时间</td><td><input type="text" name="endTime"></td><td><p style="color:#C0C0C0">格式为:HH:mm:ss</p></td>	
			</tr>
			<tr>
				<td>单价</td><td><input type="text" name="unitPrice"></td><td><p style="color:#C0C0C0">单位:HKD</p></td>
			</tr>
			<tr>
